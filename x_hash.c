...
static struct entity *add_ent(char *name)
{
...
static void add_link(struct entity *e,struct entity *focal_root)
{
        void *temp=0;
        e->num_links++;
...
static struct entity *find_entity(struct entity *e,int max,char *word)
{
        ENTRY *ent;
